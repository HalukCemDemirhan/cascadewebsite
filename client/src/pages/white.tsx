...
export default function White() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#2d5a4a', color: '#f5f5f0' }}>
      <SEO 
      ...
      <header className="w-full pt-12 pb-8 px-8 md:px-16">
        <div className="max-w-2xl mx-auto">
          <div className="mb-2 flex justify-center">
            <h1 className="text-5xl md:text-6xl font-light tracking-wide" style={{ fontFamily: 'Times New Roman, serif', color: '#f5f5f0' }}>
              cascade
            </h1>
          </div>
        </div>
      ...
      <main className="w-full px-8 md:px-16 pb-8">
        <div className="max-w-2xl mx-auto academic-content">
          ...
          <section id="research" className="mb-12">
            <h1 className="text-xl md:text-2xl mb-6 italic" style={{ color: '#d0d0c8' }}>
              Making AI Safe
            </h1>
            
            <p className="text-lg md:text-xl line-height-academic mb-8 italic" style={{ color: '#d0d0c8' }}>
          ...
          <section className="mb-4">
            <h2 className="text-lg md:text-xl font-bold mb-4" style={{ color: '#f5f5f0' }}>
              I. Agency Without Accountability
            </h2>
            <p className="text-lg line-height-academic mb-6" style={{ color: '#f5f5f0' }}>
            ...
            <p className="text-lg line-height-academic mb-8" style={{ color: '#f5f5f0' }}>
            ...
            <p className="text-lg line-height-academic mb-2" style={{ color: '#f5f5f0' }}>
